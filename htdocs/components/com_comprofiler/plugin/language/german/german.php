...
DEFINE('_UE_EDIT_TITLE','Profil aktualisieren');
...
DEFINE('_UE_AVSIZE','Max. Dateigrö�e des Bildes<br/><em>in Kilobyte</em>');
...
DEFINE('_UE_REG_COMPLETE_NOPASS_NOAPPR','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
...
DEFINE('_UE_REG_COMPLETE_NOAPPR','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
...
DEFINE('_UE_REG_COMPLETE_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
.'Eine E-Mail mit weiteren Informationen wurde an die angegebene Adresse geschickt. Bitte folge den Anweisungen in dieser Mail, um die Registrierung abzuschlie&szlig;en<br />&nbsp;&nbsp;<br />');
DEFINE('_UE_REG_COMPLETE_NOPASS_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
...
DEFINE('_UE_REGISTER','Kostenlos registrieren');
...
DEFINE('_UE_UPLOAD_DIMENSIONS','Maximale Bildgrö�e (Breite x Höhe - Dateigrö�e)');
...
DEFINE('_UE_UPLOAD_ERROR_SIZE','Die Dateigrö�e des Bildes überschreitet den erlaubten Höchstwert.');
...
DEFINE('_UE_UPLOAD_ERROR_GDNOTINSTALLED','Die GD2 Library ist nicht installiert oder nicht mit PHP compiliert. Bitte wende dich an den Systemadministrator, um die automatische Bildgrö�enänderung zu deaktivieren.');
...
DEFINE('_UE_REG_COMPLETE_NOAPPR_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
...
DEFINE('_UE_REG_COMPLETE_NOPASS_NOAPPR_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;<br />&nbsp;<br />'
...
DEFINE('_UE_POS_CB_BOTTOM','Fu�bereich (unterhalb des Hauptbereichs)');
...
DEFINE('_UE_DISPLAY_OVERLIBFIX','Overlay (fixiert, schlie�t sobald die Maus wegbewegt wird)');
...
if (!defined('_NEWPASS_MSG'))		DEFINE('_NEWPASS_MSG','Dem Benutzerkonto $checkusername ist diese E-Mail zugewiesen.\n'
.'Ein Web-Benutzer von $mosConfig_live_site verlangte die Zusendung eines neuen Passwortes.\n\n'
.'Dein neues Passwort lautet: $newpass\n\nFalls du das nicht verlangt hattest, mache dir keine Sorgen.'
.'Nur du kannst diese Nachricht sehen. Falls dies ein Fehler war, melde dich einfach mit deinem'
.'neuen Passwort an und &auml;ndere das Passwort beliebig.');
if (!defined('_NEWPASS_SUB'))		DEFINE('_NEWPASS_SUB','$_sitename :: Neues Passwort f&uuml;r - $checkusername');
if (!defined('_NEWPASS_SENT'))		DEFINE('_NEWPASS_SENT','Neues Benutzer Passwort generiert und gesendet!');
if (!defined('_REGWARN_NAME'))		DEFINE('_REGWARN_NAME','Bitte deinen Namen eingeben.');
if (!defined('_REGWARN_UNAME'))		DEFINE('_REGWARN_UNAME','Bitte einen Benutzernamen eingeben.');
if (!defined('_REGWARN_MAIL'))		DEFINE('_REGWARN_MAIL','Bitte deine E-Mail Adresse eingeben.');
...
if (!defined('_REGWARN_INUSE'))		DEFINE('_REGWARN_INUSE','Dieser Benutzername/Passwort wird schon verwendet. Bitte versuche etwas anderes.');
if (!defined('_REGWARN_EMAIL_INUSE')) DEFINE('_REGWARN_EMAIL_INUSE', 'Diese E-Mail Adresse wurde schon registriert. Wenn du dein Passwort vergessen haben solltest, klicke bitte auf "Passwort verloren?" und es wird dir ein neues Passwort zugesandt.');
...
if (!defined('_NEW_PASS_DESC'))		DEFINE('_NEW_PASS_DESC','Bitte gebe deinen Benutzernamen und deine E-Mail Adresse ein und klicke auf Passwort senden.<br />'
.'In K&uuml;rze erhältst du ein neues Passwort. Verwende dieses Passwort, um dich anzumelden.');
...
if (!defined('_SENDING_PASSWORD'))	DEFINE('_SENDING_PASSWORD','Dein Passwort wird an die angegebene E-Mail Adresse gesendet.<br />Sobald du dein neues Passwort erhalten hast,'
.'kannst du dich anmelden und danach das Passwort beliebig ändern.');
if (!defined('_LOGIN_SUCCESS'))		DEFINE('_LOGIN_SUCCESS','Du hast dich erfolgreich angemeldet');
if (!defined('_LOGOUT_SUCCESS'))	DEFINE('_LOGOUT_SUCCESS','Du hast dich erfolgreich abgemeldet');
if (!defined('_LOGIN_BLOCKED'))		DEFINE('_LOGIN_BLOCKED','Dein Benutzerkonto wurde gesperrt. Bitte kontaktiere den Administrator.');
...
if (!defined('_LOGIN_INCORRECT'))	DEFINE('_LOGIN_INCORRECT','Benutzername oder Passwort falsch. Bitte versuche es noch einmal.');
if (!defined('_USER_DETAILS_SAVE'))	DEFINE('_USER_DETAILS_SAVE','Deine Einstellungen wurden gespeichert.');
...
DEFINE('_UE_REG_USERNAMECHECKER_DESC','Benutzernamen können während der Anmeldung überprüft werden, ob sie bereits vorhanden sind. Dadurch ist es für Benutzer einfacher bei der Registrierung einen zulässigen Benutzernamen zu finden. Das ist ein experimentelles Feature, das für gro�e Seiten nicht optimiert ist. Vorher Testen!');
// 1.1: frontend:
...
DEFINE('_UE_CAPTCHA_Desc','Gib den Sicherheitscode vom Bild ein');
DEFINE('_UE_CAPTCHA_NOT_VALID','Falscher Sicherheitscode');
DEFINE('_UE_CAPTCHA_ALT_IMAGE','Bild mit Sicherheitscode');
DEFINE('_UE_CAPTCHA_AUDIO','Klicke hier, um den Sicherheitscode zu hören');
...
DEFINE('_UE_CAPTCHA_AUDIO_POPUP_CLOSEWINDOW','Fenster schlie�en');

// 1.2 Frontend:
DEFINE('_UE_ERROR_USER_NOT_SYNCHRONIZED','Benutzer existiert nicht oder Datenbank ist nicht mit CB synchronisiert.');
DEFINE('_LOGIN_TITLE','Login');
DEFINE('_LOGIN_REGISTER_TITLE','Willkommen, bitte melde dich an oder registriere dich:');
DEFINE('_UE_UPLOAD_DIMENSIONS_AVATAR','Wenn erforderlich, wird das Bild auf die maximalen Abmessungen von %s Pixeln Breite x %s Pixeln Höhe verkleinert. Das Bild darf die Grö�e von %s KByte nicht überschreiten.');
DEFINE('_UE_LOGIN_BLOCKED','Deine Anmeldung ist geblockt.');
DEFINE('_UE_REMEMBER_ME', 'Angemeldet bleiben');
DEFINE('_UE_PASSWORD_REMINDER','Passwort Erinnerung');
DEFINE('_UE_USERNAME_PASSWORD_REMINDER','Benutzername/Passwort Erinnerung');
DEFINE('_UE_REMINDER_NEEDED_FOR','Bitte Wähle');
DEFINE('_UE_LOST__USERNAME','vergessener Benutzername');
DEFINE('_UE_LOST__PASSWORD','vergessenes Passwort');
DEFINE('_UE_LOST_PASSWORD','vergessenes Passwort');
DEFINE('_UE_USERNAMEREMINDER_SUB','Erinnerung an den Benutzername für %s');
DEFINE('_UE_USERNAMEREMINDER_MSG','Hallo,\n'
.'für dein %s Konto wurde eine Erinnerung für den Benutzernamen angefragt.\n\n'
.'Dein Benutzername lautet: %s\n\n'
.'Zum Anmelden bitte auf den folgenden Link klicken:\n'
.'%s\n\n'
.'Vielen Dank.\n');
DEFINE('_UE_NEWPASS_SUB','Neues Passwort für: %s');
DEFINE('_UE_NEWPASS_MSG','Deine E-Mail wurde als Benutzerkonto %s registriert.\n'
.'Auf der Webseite %s wurde für dich ein neues Passwort angefordert.\n\n'
.'Dein neues Passwort lautet: %s\n\n'
.'Wenn du kein neues Passwort angefordert haben solltest, musst du dich mit dem automatisch erstellten Passwort einloggen und ändern.');
DEFINE('_UE_ALREADY_LOGGED_IN','Du bist bereits angemeldet.');
DEFINE('_UE_EMAIL_COULD_NOT_CHECK','Die E-Mail-Adresse scheint fehlerhaft zu sein: Bitte prüfen, sie ist zur Anmeldung erforderlich.');
DEFINE('_UE_EMAIL_COULD_NOT_CHECK_NEEDED','Die E-Mail-Adresse scheint fehlerhaft zu sein: Bitte prüfen.');
DEFINE('_UE_EMAIL_INCORRECT_CHECK','Diese E-Mail-Adresse empfängt keine Nachrichten: Bitte prüfen!');
DEFINE('_UE_EMAIL_INCORRECT_CHECK_NEEDED','Diese E-Mail-Adresse empfängt keine Nachrichten: Bitte prüfen, sie ist zur Anmeldung erforderlich.');
DEFINE('_UE_EMAIL_VERIFIED','E-Mail-Adresse scheint gültig zu sein.');
DEFINE('_UE_EMAIL_NOVALID','E-Mail-Adresse ist ungültig.');
DEFINE('_UE_EMAIL_ALREADY_REGISTERED','Diese E-Mail-Adresse ist bereits registriert.');
DEFINE('_UE_FIELDONPROFILE_SHORT','Das Feld ist im Profil sichtbar');
DEFINE('_UE_FIELDNOPROFILE_SHORT','Das Feld ist im Profil <strong>nicht</strong> sichtbar');
DEFINE('_UE_FIELDREQUIRED_SHORT','Pflichtfeld');
DEFINE('_UE_FIELDDESCRIPTION_SHORT','Information: Bewegen Sie die Maus auf das Symbol');
DEFINE('_UE_AVATAR_UPLOAD_DISCLAIMER','Mit dem Klick auf "Upload" bestätigst du, dass du die Rechte zur Veröffentlichung des Bildes besitzt.');
DEFINE('_UE_AVATAR_UPLOAD_DISCLAIMER_TERMS','Mit dem Klick auf "Upload" bestätigst du, dass du die Rechte zur Veröffentlichung des Bildes besitzt und es nicht gegen die %s verstö�t.');
DEFINE('_UE_AVATAR_TOC_LINK','Nutzungsbedingungen');
DEFINE('_UE_USER_EMAIL_CONFIRMED','Die E-Mail-Adresse wurde bereits bestätigt.');
DEFINE('_UE_LOST_USERNAME_PASSWORD','Benutzername oder Passwort vergessen?');
DEFINE('_UE_LOST_USERNAME_OR_PASSWORD','Hast du dein Benutzernamen oder Passwort vergessen?');
DEFINE('_UE_LOST_USERNAME_DESC','Wenn du deinen <strong>Benutzernamen</strong> vergessen hast, gib bitte deine registrierte E-Mail-Adresse und den Sicherheitscode ein. Klicke dann auf "Senden". Du erhältst deinen Benutzernamen per Mail zugestellt. Wenn du deine registrierte E-Mail-Adresse nicht mehr wei�t, wende dich an den Seitenbetreiber (Impressum).');
DEFINE('_UE_LOST_PASSWORD_DESC','Wenn du dein <strong>Passwort</strong> vergessen hast, aber noch deinen Benutzernamen wei�t, gib diesen, deine registrierte E-Mail-Adresse und den Sicherheitscode ein. Klicke dann auf "Senden". Du erhältst dann ein automatisch generiertes Passwort per E-Mail. Wenn du deine registrierte E-Mail-Adresse nicht mehr wei�t, wende dich an den Seitenbetreiber (Impressum).');
DEFINE('_UE_LOST_USERNAME_PASSWORD_DESC','Wenn du deinen <strong>Benutzernamen und Passwort</strong> vergessen hast, senden wir dir zunächst den Benutzernamen an deine registrierte E-Mail-Adresse. Gib hierzu bitte deine registrierte E-Mail-Adresse und den Sicherheitscode ein. Klicke dann auf "Senden". Mit dem Benutzernamen kannst du danach ein neues Passwort generieren lassen. Wenn du deine registrierte E-Mail-Adresse nicht mehr wei�t, wende dich an den Seitenbetreiber (Impressum).');
DEFINE('_UE_BUTTON_SEND','Senden');
DEFINE('_UE_BUTTON_SEND_USERNAME','Benutzername senden');
DEFINE('_UE_BUTTON_SEND_PASS','Passwort senden');
DEFINE('_UE_BUTTON_SEND_USERNAME_PASS','Senden');
define('_UE_USERNAME_EXISTS_ON_SITE',"Der Benutzername '%s' ist bereits vergeben.");
define('_UE_USERNAME_DOES_NOT_EXISTS_ON_SITE',"Der gewählte Benutzername '%s' ist bereits vergeben.");
define('_UE_USERNAME_FREE_OK_TO_PROCEED',"Der gewählte Benutzername '%s' ist noch frei: Du kannst fortfahren.");
define('_UE_THIS_IS_YOUR_USERNAME',"Das ist dein Benutzername für diese Seite.");
define('_UE_THIS_IS_USERS_USERNAME',"Das ist der derzeitige Benutzername des Benutzers auf dieser Seite.");
define('_UE_EMAIL_EXISTS_ON_SITE',"Die E-Mail-Adresse '%s' ist bereits registriert.");
define('_UE_EMAIL_DOES_NOT_EXISTS_ON_SITE',"Die E-Mail-Adresse '%s' ist noch nicht registriert.");
define('_UE_SEARCH_ERROR','Fehler beim Suchen');
define('_UE_EMAIL_SENDING_ERROR','Fehler beim Senden einer E-Mail');
DEFINE('_UE_USERNAME_REMINDER_SENT','Eine Nachricht mit deinem Benutzernamen wurde an die E-Mail-Adresse %s gesendet!');
DEFINE('_UE_NEWPASS_SENT','Ein neues Passwort wurde erzeugt und an deine E-Mail-Adresse %s geschickt!');
DEFINE('_UE_VALID_UNAME','Bitte gib einen gültigen Benutzernamen ein. Keine Leerzeichen, mindestens 3 Zeichen bestehend aus 0-9,a-z,A-Z');
DEFINE('_UE_VALID_UNAME_CHARS','Bitte gib ein gültiges %s ein. Keine Leerzeichen, mindestens %s Zeichen bestehend aus 0-9,a-z,A-Z');
DEFINE('_UE_VALID_PASS','Bitte gib ein gültiges Passwort ein. Keine Leerzeichen, mindestens 6 Zeichen bestehend aus Klein- und Gro�buchstaben, Zahlen und Sonderzeichen');
DEFINE('_UE_VALID_PASS_CHARS','Bitte gib ein gültiges %s ein. Keine Leerzeichen, mindestens %s Zeichen bestehend aus Klein- und Gro�buchstaben, Zahlen und Sonderzeichen');
DEFINE('_UE_VALID_MIN_LENGTH','Bitte gib ein gültiges %s ein bestehend aus mindestens %s Zeichen. Du hast %s Zeichen eingegeben.');
DEFINE('_UE_VALID_MAX_LENGTH','Bitte gib ein gültiges %s ein bestehend aus maximal %s Zeichen. Du hast %s Zeichen eingegeben.');
DEFINE('_UE_REGWARN_NAME','Bitte gib deinen Vor- und Nachnamen ein.');
DEFINE('_UE_REGWARN_FNAME','Bitte gib deinen Vornamen ein.');
DEFINE('_UE_REGWARN_MNAME','Bitte gib deinen zweiten Vornamen ein (falls vorhanden).');
DEFINE('_UE_REGWARN_LNAME','Bitte gib deinen Nachnamen ein.');
DEFINE('_UE_REGWARN_MAIL','Bitte gib deine E-Mail-Adresse ein. Ein Link zur Freischaltung wird dir zugesendet.');
DEFINE('_UE_REGWARN_VPASS2','Passwort und Passwort-Wiederholung stimmen nicht überein.');
...
DEFINE ('_UE_AVATAR_NO_CHANGE','Bild nicht geändert');
DEFINE ('_UE_AVATAR_UPLOAD','Profilbild hochladen');
DEFINE ('_UE_AVATAR_UPLOAD_NEW','Neues Profilbild hochladen');
DEFINE ('_UE_AVATAR_SELECT','Wähle ein Bild aus der Galerie');
...
DEFINE('_UE_REG_EMAILCHECKER_WARNING','WARNUNG: Deine PHP-Installation verfügt nicht über die Funktion "getmxrr()" oder sie ist nicht aktiviert.Da dieses eine reine Linux Funktion ist, ist das normal auf Windows-basierten Systemen und E-Mail DNS und SMTP prüfungen sind nicht möglich.');
DEFINE('_UE_REG_EMAILCHECKER_DESC','Erlaubt, dass eine E-Mail-Adresse schon während der Registrierung geprüft wird.Auch wenn dieses Feature geschützt ist, kann es unter bestimmten Umständen missbraucht werden. Das Feature ist experimental, bei gro�en Sites vorher ausprobieren!');
DEFINE('_UE_REG_EMAILCHECKER_VALID_EMAIL_ONLY','Ja, prüfe ob der E-Mail Server Adressen akzeptiert.');
DEFINE('_UE_REG_EMAILCHECKER_NOT_REGISTERED_AND_VALID_EMAIL','Ja, prüfe ob die E-Mail-Adresse noch nicht registriert ist und der E-Mail Server diese akzeptiert (Vorsicht! Siehe Warnung!)');
DEFINE('_UE_REG_UNIQUEEMAIL','Eindeutige E-Mail erforderlich');
DEFINE('_UE_REG_UNIQUEEMAIL_DESC','Wenn aktiviert, können Benutzer keine gleichen E-Mail-Adressen verwenden. Das ist eine globale CMS-Einstellung für die Site. CB gleicht das automatisch mit dieser Option ab.');
...
//DEFINE('_UE_FB_SIGNATURE', 'Deine Signatur im Forum');
...
DEFINE('_UE_FB_CONFIRMUNFAVORITEALL','Bist du sicher, dass alle Favoriten entfernt werden sollen?');
...
DEFINE('_UE_PROFILE_GALLERY_DESC','Diese Seite enthält eine kleine Galerie');
DEFINE('_UE_PROFILE_GALLERY_MODERATION','Galerie Moderation');
DEFINE('_UE_PROFILE_GALLERY_MODERATION_DESC','Diese Seite enthält alle freizugebenen Galerie-Elemente');
DEFINE('_UE_PROFILE_BOOK','Profil-Gästebuch');
DEFINE('_UE_PROFILE_BOOK_DESC','Beschreibung des Profil-Gästebuchs');
// 1.2 CB beta 8+9+10:
DEFINE('_UE_AVATAR_DISCLAIMER','Durch AnWählen von "%s" bestätigst du, dass du die Rechte an dem Foto besitzt.');
DEFINE('_UE_AVATAR_DISCLAIMER_TERMS','Durch AnWählen von "%s" bestätigst du, dass du die Rechte an dem Foto besitzt und dass es nicht gegen %s verstö�t.');
DEFINE('_UE_AGE','Alter');
DEFINE('_UE_CLOAKED','Die E-Mail Adresse ist vor Smap-Bots geschützt. Du musst JavaScript aktiviert haben, um diese im Webbrowser zu sehen.');
