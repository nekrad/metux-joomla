...
/********************************************************************************
* @ CAPTCHA-TALK
* @ A Ming based Animated Talking Captcha PHP5 Class
...
********************************************************************************/
	...
	public $colors = array('EE0000','00EE00','0000EE','00EEEE','EEEE00','EE00EE');

		// Default background color
	public $bgcolors = array('000000');

		// Swf movie width and height
	public $swf_width = 210;
	public $swf_height = 75;
	...
	public $swf_url = "swfmovie.php";
		// Html code with swf transparency
	public $swf_transparent = false;
	public $swf_validxhtml = true;

		// form input catpcha value name
	public $post_captcha = "captcha";
	...
	public $bgimages = array();
	public $bgimgauto = true;
	...
	public $dnsblists = array('zen.spamhaus.org','bl.spamcop.net','list.dsbl.org','tor.ahbl.org','opm.tornevall.org');
		// use DNSBL check if dnsblist is not empty and usednsbl = true
	private $usednsbl = false;
	private $session_dnsbl = "dnsbl";
		// On DNSBL listed - generate an error background ( NOTE: from sound dir )
	public $forbidden_img = "../../images/forbidden.gif";
		// On DNSBL listed - generate an error sound ( from sound dir )
	public $forbidden_sound = "../../audio/forbidden.mp3";

		// Internal vars
	private $bgcolor = "";
	private $captchaval = "";
	private $soundlangdefault = "english";
	
/********************************************************************************
* @ public function swfcaptcha()
* @ init class
********************************************************************************/
	public function swfcaptcha() {
		if (!session_id()) { 
...
********************************************************************************/
	private function checksound() {
		...
		for ($i = 1; $i <= $this->captcha_length; $i++) {
			// all other sound files have format  msc_captcha-character.mp3
...
********************************************************************************/
	private function deccolors($webcolors) {
