...
defined ('FIREBOARD_FRONTEND') or die ('Missing FIREBOARD_FRONTEND');
defined ('FIREBOARD_BACKEND')  or die ('Missing FIREBOARD_BACKEND');
defined ('JPATH_LEGACY')       or die ('Missing JPATH_LEGACY');
...
define('JB_ABSPATH', FIREBOARD_FRONTEND);
...
function JBgetCBprofileItemid($htmlspecialchars = false) {
    global $JB_CB__Cache_ProfileItemid;
...
*/
	...
	$database = &JFactory::getDBO();
        ...
        function isJoomla15() {
            global $mainframe;
            return is_dir(JPATH_SITE."/libraries/");
        }
