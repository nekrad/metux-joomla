...
if ($fbConfig['badwords']) {
    if (is_file(JPATH_SITE.'/components/com_badword/class.badword.php')) {
        require_once (JPATH_SITE.'/components/com_badword/class.badword.php');
    }
}
...
?>
        ...
        <!--                     <a href="<?php echo sefRelToAbs(JB_LIVEURLREL);?>">
           ...
           <?php
            if (file_exists(JPATH_SITE.'/templates/'.$mainframe->getTemplate().'/images/arrow.png')) {
