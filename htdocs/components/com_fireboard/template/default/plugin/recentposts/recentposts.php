...
global $mosConfig_lang, $mosConfig_live_site, $mainframe;
global $fbConfig;

$fireboard_adm_path = JPATH_SITE."/administrator/components/com_fireboard";
...
//Tabber check
//
$source_file = JPATH_SITE."/components/com_fireboard/template/default/plugin/recentposts/tabber.css";
$source_file = JPATH_SITE."/components/com_fireboard/template/default/plugin/recentposts/tabber.js";
$source_file = JPATH_SITE."/components/com_fireboard/template/default/plugin/recentposts/tabber-minimized.js";
$source_file = JPATH_SITE."/components/com_fireboard/template/default/plugin/recentposts/function.tabber.php";
//
        ...
        <tr>
		    ...
		    . " LIMIT $count";
                ...
                if ($numitems > $count_per_page) {
                    include_once(JPATH_SITE."/components/com_fireboard/template/default/plugin/recentposts/function.tabber.php");
