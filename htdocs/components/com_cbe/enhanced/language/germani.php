...
DEFINE('_UE_USER_UNREGISTER_CONFIRM','Du bist dabei Deinen Account zu l�schen, alle Deine Daten werden gel�scht und die Anmeldung mit diesen umn�glich. Solltest Du danach wieder als User aktiv werden wollen, registriere Dich bitte neu.');
...
DEFINE('_UE_USER_UNREGISTER_DESCRIPTION','Du bist aktuell als User registriert. Um Deinen Account zu l�schen, gib bitte Dein Passwort zweimal zur Best�tigung ein. Klick danach auf den Austragen-Button.');
DEFINE('_UE_USER_UNREGISTER_UNREGISTERED','Du bist nun von dieser Seite ausgetragen und Dein Account gel�scht.');
...
DEFINE('_UE_CBSEARCH_QUERY_EXPIRED','Die G�ltigkeitsdauer Deiner Suchanfrage ist leider abgelaufen.');
...
DEFINE('_UE_AVATAR_RULES_LINKTEXT','Bitte beachte die Regeln f�r Profilbilder.');
DEFINE('_UE_AVATAR_RULES_IGNORED','Bitte best�tige die Einhaltung der Regeln.');
//
// sv0.6233
...
Diese eMail enth�lt Deinen Benutzernamen und das Anfangskennwort mit denen Du dich auf
[SITEURL] Site anmelden kannst:

Username - [USERNAME]
Password - [PASSWORD-CLEAR]

Bitte �ndere Dein Kennwort bei Deiner ersten Anmeldung.
...
DEFINE('_UE_CBE_FILL_ALL_ERROR','Bitte f�lle alle Felder aus.');
...
DEFINE('_UE_CBE_GEOCODER_Q_OVERLOADBLOCK','Bitte warte 30 Sek. bis zur n�chsten Anfrage.');
