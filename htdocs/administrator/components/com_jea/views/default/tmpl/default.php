...
<?php echo $pane->startPanel( JText::_( 'About' ), 'pan1' ) ?>
	  ...
	  <p style="height:200px">
      	<?php echo JText::_('German Translation') ?> : Andr&eacute; Kosig, www.photo-andre.de - 1.0 (F&uuml;r ein SprachfileUpdate besuchen Sie bitte meine Website im Bereich "Webdesign)
      </p>
