...
DEFINE('_UE_TOOLS_SYNCUSERS_JOOMLA_SHOW_DESC','Zeigt eine liste von Userleichen die in der CBE Tabelle aber nicht mehr in der Joomla-User-Tabelle vorhanden sind.');
DEFINE('_UE_TOOLS_SYNCUSERS_JOOMLA','Userleichen konvertieren');
DEFINE('_UE_TOOLS_SYNCUSERS_JOOMLA_DESC','Legt die Leichen in der Joomla-User-Tabelle neu an. Sie können dann über den CBE-UserManager einfach gelöscht werden.( LOST--x )');
...
DEFINE('_UE_TOOLS_CBE_BACKUPDB','Backup DB erstellen');
DEFINE('_UE_TOOLS_CBE_BACKUPDB_DESC','Erstellt die Datentabellen für das Sichern der Config Dateien.<br>Muss nur einmal nach dem Update auf beta 1.7 ausgeführt werden. (>beta1.6, by derelvis)');
DEFINE('_UE_TOOLS_CBE_BACKUP','SICHERN');
DEFINE('_UE_TOOLS_CBE_RESTORE','HERSTELLEN');
DEFINE('_UE_TOOLS_CBE_BACKUPRESTORE_DESC','Hiermit kann die aktuelle <strong>Configuration</strong> in der Datenbank gesichert und auch wieder hergestellt werden.<br>Das ist dann nützlich, wenn der CBE aktualisiert werden soll oder wenn aufgrund von Tests die aktuelle Konfiguration vorübergehend gesichert werden soll. (>beta1.6, by derelvis)');
DEFINE('_UE_BACKUPRESTORE_DATE','Gefundene Konfiguration in der Datenbank: ');
DEFINE('_UE_TOOLS_CBE_BACKUPRESTOREENH_DESC','Hiermit kann die aktuelle <strong>Enhanced Configuration</strong> in der Datenbank gesichert und auch wieder hergestellt werden.<br>Das ist dann nützlich, wenn der CBE aktualisiert werden soll oder wenn aufgrund von Tests die aktuelle Konfiguration vorübergehend gesichert werden soll. (>beta1.6, by derelvis)');
//DEFINE('_UE_TOOLS_','');
?>