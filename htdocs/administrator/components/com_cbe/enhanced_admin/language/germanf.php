...
DEFINE('_UE_TOOLS_GEOCODER_GENXML_DESC','Hiermit wird die XML Datei welche die Geokoordinaten der User enthält erstellt. Bitte stellen Sie sicher das die Datei cbe_usermap.xml.php durch den Webserver beschreibbar ist.');
