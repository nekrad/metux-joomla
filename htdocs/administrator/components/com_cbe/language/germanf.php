...
DEFINE('_UE_PMS_DESC','Auf &quot;Nein&quot; setzen, falls Sie myPMS2 für Private Nachrichten nicht installiert haben. Andernfalls wählen Sie die entsprechende Version, um myPMS2 zu integrieren.');
...
DEFINE ('_UE_ALLOWUSERREPORTS_DESC','Gestattet Benutzern, sich über das Verhalten anderer zu beschweren.');
...
.'Ihre Registrierung muss erst überprüft und freigeschaltet werden.<br />&nbsp;&nbsp;'
.'Bei Freischaltung erhalten Sie ein Passwort per E-Mail und können sich dann anmelden.');
DEFINE('_UE_REG_COMPLETE_NOAPPR','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;&nbsp;'
.'Ihre Registrierung muss erst überprüft und freigeschaltet werden. <br />&nbsp;&nbsp;'
.'Bei Freischaltung erhalten Sie eine E-Mail und können sich dann anmelden.');
DEFINE('_UE_REG_COMPLETE_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;&nbsp;'
.'Eine E-Mail mit weiteren Informationen wurde an die angegebene Adresse geschickt. Bitte folgen Sie den Anweisungen in dieser Mail, um die Registrierung abzuschließen.<br />&nbsp;&nbsp;');
...
.'Wenn Sie das Passwort erhalten haben, folgen Sie den Anweisungen in der E-Mail, um sich anmelden zu können.');
...
DEFINE('_LOGIN_NOT_CONFIRMED','Registrierung nicht vollständig! Weitere Hinweise finden Sie in Ihrem E-Mail-Posteingang.');
...
DEFINE('_UE_USERUNBANREQUEST_SUCCESSFUL','Ihr Benutzerprofil-Entsperrungsantrag ist erfolgreich übermittelt worden.');
...
DEFINE('_UE_BANUSER_MSG','Ihr Benutzerprofil wurde von einem Administrator gesperrt. Bitte melden Sie sich an, um den Grund für die Sperre zu erfahren.');
...
DEFINE('_UE_UPLOAD_ERROR_GDNOTINSTALLED','Die GD2 Library ist nicht installiert oder nicht mit PHP kompiliert. Bitte wenden Sie sich an den Systemadministrator, um die automatische Bildgrößenänderung zu deaktivieren.');
DEFINE('_UE_UPLOAD_ERROR_UPLOADFAILED','Fehler beim Hochladen des Bildes!');
DEFINE('_UE_TOC','Nutzungsbedingungen akzeptieren');
DEFINE('_UE_TOC_REQUIRED','Zur Registrierung müssen Sie die Nutzungsbedingungen akzeptieren');
...
DEFINE('_UE_SENDEMAILNOTICE','ANMERKUNG: Das ist eine Nachricht von %s bei %s ( %s ). Der Benutzer hat Ihre E-Mail-Adresse nicht gesehen. Falls Sie darauf antworten, wird der Benutzer Ihre E-Mail-Adresse sehen können. %s ist für den Inhalt der E-Mail nicht verantwortlich.');
...
.'Ihre Registrierung erfordert Freischaltung und E-Mail-Rückbestätigung. Bitte folgen Sie den Anweisungen in der E-Mail, die Sie erhalten haben. Nach der Freischaltung können Sie sich anmelden.<br />&nbsp;&nbsp;');
DEFINE('_UE_REG_COMPLETE_NOPASS_NOAPPR_CONF','<span class="componentheading">Registrierung abgeschlossen!</span><br />&nbsp;&nbsp;'
.'Ihre Registrierung erfordert Freischaltung und E-Mail-Rückbestätigung. Bitte folgen Sie den Anweisungen in der E-Mail, die Sie erhalten haben.<br />&nbsp;&nbsp;'
.'Nach Freischaltung wird Ihnen ein Passwort zugesendet, mit dem Sie sich einloggen können.');
DEFINE('_UE_NAME_STYLE','Name Felder');
DEFINE('_UE_NAME_STYLE_DESC','Hier können Sie angeben, wie viele Felder der Benutzername in Mambo umfassen soll.');
DEFINE('_UE_USER_CONFIRMED_NEEDAPPR','Danke für die Bestätigung Ihrer E-Mail-Adresse. Ihre Registrierung muss jetzt noch von einem Moderator freigeschaltet werden. Sie erhalten eine E-Mail, nachdem Ihre Anmeldung geprüft wurde.');
DEFINE('_UE_YOUR_FNAME','Vorname');   
DEFINE('_UE_YOUR_MNAME','Zweiter Vorname');
DEFINE('_UE_YOUR_LNAME','Nachname');

//RC 1 Build
DEFINE('_UE_NOSELFEMAIL','Sie können keine E-Mail an sich selbst senden!');
...
DEFINE('_UE_REG_FIRST_VISIT_URL_DESC','Geben Sie die URL der Seite an, die der Benutzer nach seiner ersten Anmeldung nach der Registrierung zu sehen bekommen soll. Diese Seite kann zum Beispiel eine Willkommen-Seite für neue Mitglieder sein, wichtige Anleitungen enthalten oder die Profil-Seite des Benutzer sein. Wenn Sie dieses Feld frei lassen, wird der Benutzer auch bei der ersten Anmeldung normal weitergeleitet.');
