...
INSERT INTO `#__jce_plugins` (`id`, `title`, `name`, `type`, `icon`, `layout`, `row`, `ordering`, `published`, `editable`, `elements`, `iscore`, `checked_out`, `checked_out_time`, `params`, `variables`) VALUES
