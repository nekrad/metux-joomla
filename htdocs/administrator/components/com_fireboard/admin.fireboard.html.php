...
require_once(JPATH_LEGACY.'classes.php');
...
include (FIREBOARD_FRONTEND.'/sources/fb_version.php');
// << $fbversion
?>
...
?>
        ...
        <?php
        $path = FIREBOARD_BACKEND.'/fb_cpanel.php';
        if (file_exists($path)) {
            require $path;
        }
        else
        {
            echo '<br />mcap==: missing: "'.$path.'" .... help!!';
...
/// Dan Syme/IGD Rank Administration
 function showRanks( $option,$mosConfig_lang,&$ranks,$pageNavSP,$order,$rankpath )  
  ...
  <table class="adminlist" border=0 cellspacing=0 cellpadding=3 width="100%" >
    ...
    <?php 
					$k=0;
					// hack: prevent warning on empty data
