		...
		<tr>
			...
			for ($i=0, $n=count( $rows ); $i < $n; $i++) {
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td>
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit' );?>::<?php echo $row->post_title; ?>">
						<?php
				...
				<tbody>
					...
					<tr>
						...
						<div id="clsTableTdPadd">
							<div><textarea cols="55" rows="10" name="post_desc" id="post_desc" class="inputbox required"  onkeyup="textCounter(document.adminForm.post_desc,document.adminForm.remLen0,240)" onkeydown="textCounter(document.adminForm.post_desc,document.adminForm.remLen0,240)" ><?php echo $row->post_desc;?></textarea> *</div>
