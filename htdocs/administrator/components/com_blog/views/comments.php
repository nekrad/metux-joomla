				...
				<tbody>
					...
					<tr>
						...
						<div id="clsTableTdPadd">
							<div><textarea cols="60" rows="8" name="comment_desc" id="comment_desc" class="inputbox required"  onkeyup="textCounter(document.adminForm.comment_desc,document.adminForm.remLen0,240)" onkeydown="textCounter(document.adminForm.comment_desc,document.adminForm.remLen0,240)" ><?php echo $row->comment_desc;?></textarea> *</div>
