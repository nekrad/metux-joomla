...
$writescriptfilename = 'writefiles.php';

require_once('./getid/getid3.php');
...
if (isset($_REQUEST['filename'])) {
	...
	$listdirectory = (isset($_REQUEST['listdirectory']) ? getid3_lib::SafeStripSlashes($_REQUEST['listdirectory']) : $soundfiles."/" );
	$listdirectory = realpath($listdirectory); // get rid of /../../ references
